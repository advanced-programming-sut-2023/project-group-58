...
public enum BuildingEnum {
    ...
    ENGINEERS_GUILD(BuildingEnumType.BUILDING,"engineers guild", 0, 0,100, new Resource(ResourceEnum.WOOD, 10), 0),
    ...
    PERIMETER_TOWER(BuildingEnumType.TOWER,"perimeter tower", 0,0, 0, new Resource(ResourceEnum.STONE, 10), 0),
    DEFENSE_TURRET(BuildingEnumType.TOWER, "defense turret", 0,0, 0, new Resource(ResourceEnum.STONE, 15), 0),
    KILLING_PIT(BuildingEnumType.TRAP,"killing pit", 0,0, 0, new Resource(ResourceEnum.WOOD, 6), 0),
    SQUARE_TOWER(BuildingEnumType.TOWER, "square tower", 0,0, 0, new Resource(ResourceEnum.STONE, 35), 0),
    ROUND_TOWER(BuildingEnumType.TOWER, "round tower", 0, 0,0, new Resource(ResourceEnum.STONE, 40), 0),
    SMALL_STONE_GATEHOUSE(BuildingEnumType.GATE, "small stone gatehouse", 0,0, 0, new Resource(null, 0), 0),
    BIG_STONE_GATEHOUSE(BuildingEnumType.GATE, "big stone gatehouse", 0, 0,0, new Resource(ResourceEnum.STONE, 20), 0),
    ...
    MERCENARY_POST(BuildingEnumType.BUILDING, "mercenary post", 0,0, 0, new Resource(ResourceEnum.WOOD, 10), 0),
    IRON_MINE(BuildingEnumType.RESOURCE_MAKER, "iron mine", 0,0, 0, new Resource(ResourceEnum.WOOD, 20), 2),
    ...
    OX_TETHER(BuildingEnumType.RESOURCE_MAKER, "ox tether", 0,0, 0, new Resource(ResourceEnum.WOOD, 5), 1),
    PITCH_RIG(BuildingEnumType.RESOURCE_MAKER, "pitch rig", 0,0, 0, new Resource(ResourceEnum.WOOD, 20), 1),
    QUARRY(BuildingEnumType.RESOURCE_MAKER, "quarry", 0,0, 0, new Resource(ResourceEnum.WOOD, 20), 3),
    APPLE_ORCHARD(BuildingEnumType.RESOURCE_MAKER, "apple orchard", 0,0, 0, new Resource(ResourceEnum.WOOD, 5), 1),
    DIARY_FARM(BuildingEnumType.RESOURCE_MAKER, "diary farmer", 0,0, 0, new Resource(ResourceEnum.WOOD, 10), 1),
    WHEAT_FARM(BuildingEnumType.RESOURCE_MAKER, "wheat farm", 0,0, 0, new Resource(ResourceEnum.WOOD, 15), 1),
    ...
    POLE_TURNER(BuildingEnumType.RESOURCE_MAKER, "pole turner", 0,0, 100, new Resource(ResourceEnum.WOOD, 10), 1),
    OIL_SMELTER(BuildingEnumType.RESOURCE_MAKER, "oil smelter", 0, 0,100, new Resource(ResourceEnum.IRON, 10), 1),
    //WALL(BuildingEnumType.BUILDING, "wall", 0, 0, new Resource(ResourceEnum.STONE, 0), 0),
    HUNTERS_POST(BuildingEnumType.RESOURCE_MAKER, "hunter post", 0,0, 0, new Resource(ResourceEnum.WOOD, 5), 1),
    SIEGE_TENT(BuildingEnumType.BUILDING, "siege tent", 0,0, 0, new Resource(null, 0), 0),
