...
public enum UnitEnum {
    PIKE_MAN("pike_man", ResourceEnum.PIKE,0,0,0,0,0,false),
    TUNNELER("tunneler",ResourceEnum.NULL,0,0,0,0,0,false),
    ARCHER_BOW("archer_bow",ResourceEnum.BOW,0,0,0,0,0,true),
    KING("king",ResourceEnum.NULL,0,0,0,0,0,false),
    ARCHER("archer",ResourceEnum.BOW,0,0,0,0,0,false),
    SPEAR_MAN("spear_man",ResourceEnum.SPEAR,0,0,0,0,0,false),
    SWORDS_MAN("swords_man",ResourceEnum.SWORD,0,0,0,0,0,false),
    CROSSBOW_MAN("crossbow_man",ResourceEnum.CROSSBOW,0,0,0,0,0,false),
    MACE_MAN("mace_man",ResourceEnum.MACE,0,0,0,0,0,false),
    SOLDIER_ENGINEER("soldier_engineer",ResourceEnum.NULL,0,0,0,0,0,false),
    KNIGHT("knight",ResourceEnum.HORSE,0,0,0,0,0,false),
    BLACK_MONK("black_monk",ResourceEnum.WOOD,0,0,0,0,0,false),
    HORSE_ARCHER("horse_archer",ResourceEnum.HORSEANDBOW,0,0,0,0,0,true),
    ARABIAN_SWORDSMAN("arabian_swordsman",ResourceEnum.SWORD,0,0,0,0,0,true),
    LADDER_MAN("ladder_man",ResourceEnum.WOOD,0,0,0,0,0,false),
    ASSASSIN("assassin",ResourceEnum.NULL,0,0,0,0,0,true),
    FIRE_THROWER("fire_thrower",ResourceEnum.NULL,0,0,0,0,0,true),
